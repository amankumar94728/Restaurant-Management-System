...
import Carasul from "./Caraousel";
import { ThemeProvider, createTheme } from '@mui/material/styles';
import CssBaseline from '@mui/material/CssBaseline';
import Menuitems from "../shop_admin/menu/menu_item_admin";
...
export default function PrimarySearchAppBar() {
  ...
  return (
    ...
    <Typography>
      ...
      <Button variant="dark" component={Link} to={`/${value}/book-table`}> BOOK TABLE </Button>
      <Button variant="dark" href="#contained-buttons">  TAKE AWAY  </Button>
      </Stack>
    </Box>
